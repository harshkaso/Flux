import numpy as np
def color_by_position(particles, cos_angles, sin_angles, ttl_particles, ff_width, ff_height, min_rgb, max_rgb, speed, base_alpha):
    ...
    a = np.repeat(base_alpha, ttl_particles)
    return r, g, b, a

def color_by_position(particles, cos_angles, sin_angles, ttl_particles, ff_width, ff_height, min_rgb, max_rgb, speed, base_alpha):
    factor_x = cos_angles / speed
    factor_y = sin_angles / speed
